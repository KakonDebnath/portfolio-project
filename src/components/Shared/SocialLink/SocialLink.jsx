...
const SocialLink = ({gap}) => {
    return (
        <div className={`flex justify-center text-lg ${gap ? "gap-5 text-4xl" : "gap-2"}`}>
            <Link to="https://github.com/KakonDebnath" target='_blank'><FaGithub className='' /></Link>
            <Link to="https://www.linkedin.com/in/kakanchandra96/" target='_blank'><FaLinkedin className='text-blue-500' /></Link>
